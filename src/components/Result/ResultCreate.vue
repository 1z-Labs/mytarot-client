      ...
      switch (chapterTitle) {
        ...
        case "이성이 보는 나의 매력과 분위기":
          prompt = `
            ...
            상대방이 보는 사용자의 매력과 분위기를 400자 이내로 설명해 주세요.
          `;
          break;
        ...
        case "연애운이 들어오는 3번의 시기":
          prompt = `
            ...
            이 사용자가 앞으로 3번의 중요한 연애 시기를 맞이할 것입니다. 그 시기는 언제이며, 어떤 특징을 가질지 400자 이내로 설명해 주세요.
          `;
          break;
        ...
        case "연애운을 연애 골든타임으로!":
          prompt = `
            ...
            연애운이 들어오는 시기에 어떻게 하면 연애를 성공할 수 있을지 400자 이내로 설명해줘.
          `;
          break;
        ...
        case "그 사람의 마음을 사로잡는 비법":
          ...
          상대방의 사주를 바탕으로 그 사람의 마음을 사로잡는 방법에 대한 조언을 해주세요. 상대방의 성격, 관심사, 사랑하는 방식 등과 관련된 정보도 알려주시면 좋겠습니다. 이 사주를 기반으로 관계를 발전시킬 수 있는 구체적인 조언을 400자 이내로 부탁드립니다.
          `;
          break;
        ...
        case "마지막으로 도화가 정하는 말":
          prompt = `
            ...
            지금까지 나왔던 답변들을 최종적으로 요약해서 잘 될거다라는 좋은 말을 400자 이내로 작성해주세요.
